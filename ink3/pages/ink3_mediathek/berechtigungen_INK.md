---
Title: Berechtigungen mit Switch Edu-ID
Type: Info
CollectionTitle: 
Docs: 
--- 

Mit der [Switch edu-ID](https://eduid.ch/registration) erhalten alle Studierenden und alle, die an einer Hochschule tätig oder zu Gast sind eine persönliche Identität. 
