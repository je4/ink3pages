...
Collectionfield: Practice Based Research; Open and Free Access; Education; Collaborative Practices
Docs: 95
---
...
Located geographically in the trinational border region around Basel, Grenzgang methodically locates itself between artistic research and Lucius Burckhardt's promenadology. The project has two central objectives: firstly, it deals with the question of how we perceive space, specifically the trinational space of the Basel region. Secondly, it asks how the mode of artistic research can become effective in an art educational (understood as discursive) practice.

To demonstrate and discuss how knowledge is generated in a project that explicitly operates in the mode of artistic research, a detailed documentation of the procedures and emerging notations and implementations was indispensable. What also applies to the transfer to art education: relevant for an epistemic practice of art education are the working methods, intermediate steps, open questions resulting from notations and implementations, the breaks and irritations resulting from the artistic mode of research. The dataset of Grenzgang wants to point out precisely these working methods, intermediate steps, breaks, irritations, but also the consequences and results to be derived from them, and feed them into the discussion.
...
- Talk I BA
- Walk 1I BA
- Walk 2 Spaziergang semipermeabel
- Walk Giswil
- Walk Rotterdam
